    ...
    <main className="admin-dashboard-theme min-h-screen bg-(--admin-bg) text-(--admin-text-primary)">
      <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(99,102,241,0.18),transparent_22%),linear-gradient(180deg,var(--admin-bg)_0%,#070b13_100%)]">
        ...
        <section className="mx-auto max-w-7xl px-5 pb-16 pt-28 sm:px-8">
          <div className="rounded-[28px] border border-(--admin-border) bg-[rgba(8,12,20,0.38)] p-8 shadow-[0_30px_80px_-40px_rgba(99,102,241,0.28)] backdrop-blur-sm sm:p-10">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              <div className="admin-panel rounded-2xl p-6">
                ...
                <p className="mt-3 font-(--font-serif) text-3xl tracking-[-0.04em]">
                  Ready
                </p>
