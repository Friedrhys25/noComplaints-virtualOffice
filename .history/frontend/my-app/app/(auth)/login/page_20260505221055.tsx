        ...
        <div className="mx-auto grid min-h-[calc(100vh-48px)] w-full max-w-7xl overflow-hidden rounded-3xl border border-[var(--border-base)] bg-[rgba(8,12,20,0.78)] shadow-[var(--shadow-hero)] backdrop-blur-xl lg:min-h-screen lg:grid-cols-[45fr_55fr] lg:rounded-none lg:border-0">
            ...
            <div className="relative z-10">
                ...
                <figcaption className="mt-5 flex items-center gap-3">
                    ...
                    <span>
                    <span className="block text-sm font-semibold">Ari Reyes</span>
                    <span className="block text-xs text-[var(--text-muted)]">Design Operations Lead</span>
                    </span>
                </figcaption>
                </figure>
            </div>
            ...
            <div className="w-full max-w-md">
                ...
                <button type="button" className="vo-button-secondary flex h-11 items-center justify-center gap-3 rounded-xl border border-[var(--border-strong)] px-4 text-sm font-semibold">
                    <GoogleIcon />
                    Google
                </button>
                <button type="button" className="vo-button-secondary flex h-11 items-center justify-center gap-3 rounded-xl border border-[var(--border-strong)] px-4 text-sm font-semibold">
